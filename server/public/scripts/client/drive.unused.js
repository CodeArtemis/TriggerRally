...
define([
  ...
  var trees = [];
  var renderTerrain, renderScenery;
  var meshCheckpoint;
  var meshArrow, meshArrowNext;
  var containerEl = $('.frame3d').first();
  var checkpointsEl = $('#checkpoints').first();
  var countdownEl = $('#countdown').first();
  var runTimerEl = $('#timer').first();
  var twitterLinkEl = $('#twitterlink').first();
  var fullscreenLinkEl = $('#fullscreenlink').first();
  var saveReplayLinkEl = $('#savereplaylink').first();
  var replaysContainerEl = $('#replays').first();
  ...
  exports.run = function() {
    ...
    */
    ...
    client = new clientClient.TriggerClient(containerEl);
    ...
    */
    ...
    /*
    aud = new clientAudio.WebkitAudio();

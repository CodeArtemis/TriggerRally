...
skyColors:[],groundColors:[],positions:[]}},j,qc,Bc,dc,Db;if(!(j=K.getContext("experimental-webgl",{alpha:P,premultipliedAlpha:ca,antialias:xa,stencil:M,preserveDrawingBuffer:pa})))throw"Error creating WebGL context.";qc=j.getExtension("OES_texture_float");Bc=j.getExtension("OES_standard_derivatives");dc=j.getExtension("EXT_texture_filter_anisotropic")||j.getExtension("MOZ_EXT_texture_filter_anisotropic")||j.getExtension("WEBKIT_EXT_texture_filter_anisotropic");Db=
